...
//!
//! \brief The MODBUS/RTU client class
//!
class RtuClient : public Client, public RTUDevice
{
    Q_OBJECT
    ...
    public:
        ...
        //! \param parent - Qt parent object
        //!
        explicit RtuClient(const QString& portName, QObject *parent = nullptr);
    ...
    protected :  // fields
        ...
        //!
        //! \brief Flag showng that client is in silence mode
        //!
        bool inSilenceState_;

        //!
        //! \brief Timer for controlling silence time in serial line.
        //!
        //! For baud rate more than 19200 bps silence time should be not less 1750 mcs.
    ...
    protected :  // methods
        ...
        //!
        //! \brief Send data to modbus server with silence time controlling
    ...
    private slots:
        ...
        //!
        //! \brief Start silence timer
        //!
        void startSilence_();

        //!
        //! \brief Finish silence time
        //!
        void stopSilence_();
};
